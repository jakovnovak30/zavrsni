...
\textbf{TODO: } napiši ovo

Ukoliko želimo da naš okvir bude koristan, potrebno je implementirati operaciju matričnog množenja, pošto je ona neophodna za rad neuralnih mreža.
bla bla bla \textbf{dovrši ovo}

\lstinputlisting[language=C++, firstline=20]{../../include/autograd_core/matrix_operations.hpp}

\pagebreak
\section{Demonstracijski programi}
\subsection{Skalarne funkcije}
\lstinputlisting[language=C++]{../../demo/visualize_demo.cpp}
\textbf{TODO:} ubaci rezultat vizualizacije i opiši kod malo...
