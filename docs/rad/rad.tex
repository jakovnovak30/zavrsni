...
\begin{zahvale}
  ...
  Zahvaljujem profesoru Šegviću na suradnji tijekom pisanja rada te kolegama i obitelji na podršci tijekom studija.
\end{zahvale}
...
\lstinputlisting[language=C++]{../../demo/mnist_classifier.cpp}
...
\lstinputlisting[language=python]{../../demo/mnist_classifier.py}
